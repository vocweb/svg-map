<template>
    <article class="examples__block">
        ...
        <div class="examples__block__map">
            <svg-map :map="France" location-role="link" @mouseover="pointLocation" @mouseout="unpointLocation" @focus="focusLocation" @blur="blurLocation" @click="clickLocation" />
        </div>
    </article>
</template>

<script>
import France from '@svg-country-maps/france.regions'
